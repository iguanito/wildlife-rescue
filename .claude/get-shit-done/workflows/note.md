...
- **Global scope**: `/home/arnaud/workspace/perso/wildlife-rescue/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/arnaud/workspace/perso/wildlife-rescue/.claude/notes/`)
...
2. Glob `/home/arnaud/workspace/perso/wildlife-rescue/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/arnaud/workspace/perso/wildlife-rescue/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/arnaud/workspace/perso/wildlife-rescue/.claude/notes/` — works in any directory
